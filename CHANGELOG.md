...
### 1.7.0 (273)
🎄 Happy New Year to everyone! [WebK](http://web.xuegao.cc.cd/k) launched its first update of 2023, adding a pack of features you can now enjoy on Web!
...
Media hidden with a shimmering spoiler effect is properly displayed in the app – just tap or click to view the image. The next [WebK](http://web.xuegao.cc.cd/k) update will allow you to send media with this spoiler effect.
...
### 1.6.0 (244)
Today, [WebK](https://web.xuegao.cc.cd/k) introduces a redesigned **Emoji and Sticker Panel** – try the **collapsible section** for default emoji categories and the **scrollable bar** for your custom emoji sets.
